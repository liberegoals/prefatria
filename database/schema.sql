...
-- επαφή με τον server.
--
-- Ο πίνακας πρόκειται να κρατήσει μεγάλο όγκο δεδομένων και γι' αυτό το λόγο είναι
-- compressed. Αυτό δεν αποτελεί σημαντικό πρόβλημα, καθώς οι αλλαγές στον πίνακα
-- τραπεζιών είναι μάλλον σπάνιες.
...
-- Ο πίνακας πρόκειται να κρατήσει μεγάλο όγκο δεδομένων και γι' αυτό το λόγο είναι
-- compressed. Αυτό δεν αποτελεί σημαντικό πρόβλημα, καθώς οι αλλαγές στον πίνακα
-- παραμέτρων των τραπεζιών είναι μάλλον σπάνιες.
--
--	ΚΑΣΑ		50
...
--
-- Ο πίνακας πρόκειται να κρατήσει τεράστιο όγκο δεδομένων και για το λόγο αυτό είναι
-- compressed, πράγμα που είναι κάπως προβληματικό καθώς οι κινήσεις στον πίνακα δεν
-- είναι σπάνιες, αλλά μάλλον συχνές. Πράγματι, σε τραπέζια στα οποία εξελίσσονται
-- διανομές γίνεται μια ενέργεια κάθε 2 δευτερόλεπτα κατά μέσο όρο. Σε ένα περιβάλλον
-- με 200 τραπέζια αυτό μεταφράζεται σε 100 ενέργειες το δευτερόλεπτο.
