	...
	this.efoplismosPexnidiFila(iseht, over).each(function() {
		...
		on('click', function(e) {
			...
			Arena.partida.kinisiFilo(pektis, filoDom, function() {
				// Η παρούσα function καλείται μόλις η κίνηση του φύλλου
				// προς το κέντρο έχει περατωθεί.

				// Αν έχω παραμείνει σε κατάσταση 1 σημαίνει ότι δεν έχει
				// παραληφθεί ακόμη η κοινοποίηση της ενέργειας από τον σέρβερ,
				// οπότε μαρκάρω 2 που σημαίνει ακριβώς αυτό.
