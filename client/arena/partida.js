...
Arena.partida.enimerosiRefreshDOM = function() {
	...
	if (Arena.ego.oxiTrapezi()) {
		...
		append($('<div>').text("Βρίσκεστε στον «Πρεφαδόρο», δηλαδή στο διαδικτυακό καφενείο της πρέφας.")).
		...
		append($('<div>').text("Μπορείτε, ακόμη, να παρακολουθήσετε τις παρτίδες που εξελίσσονται " +
			"σε άλλα τραπέζια του καφενείου, κάνοντας κλικ στον κωδικό τραπεζιού από το χώρο " +
			"του καφενείου."));
		Arena.partida.enimerosiDOM.children().css({
			padding: '10px',
			backgroundColor: '#8AA886',
		});
	}
